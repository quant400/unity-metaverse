...
public class Web3MintExample : MonoBehaviour
{
    async public void OnMintAccount()
    {
        ...
        string value = "0";
        string cid = "QmbnT8LsBCShSaeSSXyrmX1rHdWZdbj45Whyioomqekwr4";
        ...
        string response = await EVM.MintNFTTransaction(chain, network, account, toAccount,value, cid, data, signature, gasPrice, gasLimit, rpc);
        print(response);
